...
**Source maps upload, and never resolve.** The build log is clean — 253 files
with maps, zero auth failures — and frames still arrive minified, because the
scrubber redacts the id that joins the two. Seen in the Sentry UI 31 Aug; §10.
